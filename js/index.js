            ...
            case 'IcosahedronGeometry':
                if (currentcolor == 0xF66120) {
                    if (planetViewed == 0) {
                        ...
                        info.innerHTML = "I'm <span>Sanju</span>  Antala,";
                        subtitle.innerHTML = "a <span>front-end developer</span> from India.";
                ...
                if (currentcolor == 0x26D7E7) {
                    if (planetViewed == 1 || planetViewed==3 || planetViewed==4) {
                        ...
                        description.innerHTML = "You can find all my experiments here :  <br/><a target='_blank' href='https://codepen.io/'>my Codepen</a><br/><br/><div>Click on the other planets to learn more ...<div>";
